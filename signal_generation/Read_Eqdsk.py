...
def gen_grid_Eqdsk(
    eqdsk_file="/home/rian/Documents/reconstructions/hbt_115600/run_3/Psitri.eqdsk",
    m=2,
    n=1,
):
    ...
    psi_norm = (eqdsk_obj["psirz"] - eqdsk_obj["psiax"]) / (
        eqdsk_obj["psilcf"] - eqdsk_obj["psiax"]
    )
